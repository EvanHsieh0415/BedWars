...
# 全局点
kill @e[type=text_display,tag=jkbw_worldspawn]
summon text_display ~.5 ~ ~-3.5 {billboard:"center",Tags:["jkbw","jkbw_worldspawn","jkbw_worldspawn","jkbw_new_display"],line_width:200,text:'""'}
data modify block 10110222 1 10110222 back_text.messages[0] set value '[{"storage":"jk:bw","nbt":"txt.display.global_point.name","color":"gold"}]'
function jkbw:load/settings/menu/text_display