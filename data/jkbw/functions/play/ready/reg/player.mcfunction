...
# 测试模式提示
execute if score #test_mode jkbw.mem matches 1 run item replace entity @s[nbt=!{Inventory: [{Slot: 8b, tag: {jkbw: ["reg", "0"]}}]}] hotbar.8 from block 10110209 3 10110222 container.2
