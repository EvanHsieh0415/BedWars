...
# 轮换道具（分数1才启用）
execute if score #res_mode jkbw.mem matches 0..1 run function jkbw:play/start/alternation
...
# 高度
execute at @e[type=text_display,tag=jkbw_worldspawn,limit=1] run fill ~-110 ~ ~-110 ~110 ~ ~110 barrier replace air
execute unless score #WYmin jkbw.mem matches -60..200 run scoreboard players set #WYmin jkbw.mem 0
