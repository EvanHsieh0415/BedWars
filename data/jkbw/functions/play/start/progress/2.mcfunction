...
execute if score #res_mode jkbw.mem matches 2 run tellraw @a ["",{"translate":"attribute.name.generic.max_health"}," ",{"storage":"jk:bw","nbt":"txt.print.now_become"}," ",{"text":"40","color":"red"},"."]