...
execute as @e[type=text_display,tag=jkbw_diamond_time] at @s run function jkbw:play/res/extra/diamond
execute as @e[type=text_display,tag=jkbw_emerald_time] at @s run function jkbw:play/res/extra/emerald

# 全局
function jkbw:play/res/diamond
function jkbw:play/res/emerald
