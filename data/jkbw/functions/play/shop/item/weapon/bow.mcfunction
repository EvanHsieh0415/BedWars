...
# 成功购买
$execute if score #1 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] bow{CanPlaceOn: ["#jkbw:canplaceon"], CanDestroy: ["#jkbw:candestroy"], HideFlags: 28, Unbreakable: True}
$execute if score #2 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] bow{CanPlaceOn: ["#jkbw:canplaceon"], CanDestroy: ["#jkbw:candestroy"], HideFlags: 28, Unbreakable: True, Enchantments: [{id: "power", lvl: 1}]}
$execute if score #3 jkbw.mem matches $(id) run give @s[tag=jkbw_buy_success] bow{CanPlaceOn: ["#jkbw:canplaceon"], CanDestroy: ["#jkbw:candestroy"], HideFlags: 28, Unbreakable: True, Enchantments: [{id: "power", lvl: 1}, {id: "punch", lvl: 1}]}
