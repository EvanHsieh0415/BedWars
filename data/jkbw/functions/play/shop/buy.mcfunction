## 获取玩家身上的资源数量及显示
execute store result score @s jkbw.Player.OwnIrons run clear @s iron_ingot{CanPlaceOn: ["#jkbw:canplaceon"], CanDestroy: ["#jkbw:candestroy"]} 0
execute store result score @s jkbw.Player.OwnGolds run clear @s gold_ingot{CanPlaceOn: ["#jkbw:canplaceon"], CanDestroy: ["#jkbw:candestroy"]} 0
execute store result score @s jkbw.Player.OwnDiamonds run clear @s diamond{CanPlaceOn: ["#jkbw:canplaceon"], CanDestroy: ["#jkbw:candestroy"]} 0
execute store result score @s jkbw.Player.OwnEmeralds run clear @s emerald{CanPlaceOn: ["#jkbw:canplaceon"], CanDestroy: ["#jkbw:candestroy"]} 0
