...
execute if score #res_mode jkbw.mem matches 0..1 run function jkbw:play/shop/buy/real
execute if score #res_mode jkbw.mem matches 2 run function jkbw:play/shop/buy/_real
