...
# 成功购买
execute as @s[team=jkbw.yellow,tag=!jkbw_bought,tag=jkbw_buy_success] run tellraw @a[team=jkbw.yellow] ["",{"selector":"@s"}," ",{"storage":"jk:bw","nbt":"txt.print.buy_ed2","color":"green"}," ",{"storage":"jk:bw","nbt":"txt.item.shop.trap.list.name.mining","color":"gold"}]

execute as @s[team=jkbw.yellow,tag=!jkbw_bought,tag=jkbw_buy_success] run tag @e[type=text_display,tag=jkbw_bed_yellow,scores={jkbw.Team.TrapNum=0},limit=1] add jkbw_trap_mining_1
execute as @s[team=jkbw.yellow,tag=!jkbw_bought,tag=jkbw_buy_success] run tag @e[type=text_display,tag=jkbw_bed_yellow,scores={jkbw.Team.TrapNum=1},limit=1] add jkbw_trap_mining_2
execute as @s[team=jkbw.yellow,tag=!jkbw_bought,tag=jkbw_buy_success] run tag @e[type=text_display,tag=jkbw_bed_yellow,scores={jkbw.Team.TrapNum=2},limit=1] add jkbw_trap_mining_3
