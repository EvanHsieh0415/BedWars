...
# 成功购买
execute as @s[team=jkbw.gray,tag=!jkbw_bought,tag=jkbw_buy_success] run tellraw @a[team=jkbw.gray] ["",{"selector":"@s"}," ",{"storage":"jk:bw","nbt":"txt.print.buy_ed2","color":"green"}," ",{"storage":"jk:bw","nbt":"txt.item.shop.trap.list.name.defend","color":"gold"}]

execute as @s[team=jkbw.gray,tag=!jkbw_bought,tag=jkbw_buy_success] run tag @e[type=text_display,tag=jkbw_bed_gray,scores={jkbw.Team.TrapNum=0},limit=1] add jkbw_trap_defend_1
execute as @s[team=jkbw.gray,tag=!jkbw_bought,tag=jkbw_buy_success] run tag @e[type=text_display,tag=jkbw_bed_gray,scores={jkbw.Team.TrapNum=1},limit=1] add jkbw_trap_defend_2
execute as @s[team=jkbw.gray,tag=!jkbw_bought,tag=jkbw_buy_success] run tag @e[type=text_display,tag=jkbw_bed_gray,scores={jkbw.Team.TrapNum=2},limit=1] add jkbw_trap_defend_3
