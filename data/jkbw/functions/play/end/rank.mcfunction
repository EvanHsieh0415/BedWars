tellraw @a ["\n",{"storage":"jk:bw","nbt":"txt.print.rank_list","bold":true}]
...
tellraw @a ["\n",{"storage":"jk:bw","nbt":"txt.print.1st","color":"yellow","bold":true}," ",{"selector":"@a[tag=jkbw_rank1]"}," - ",{"score":{"name":"#kill_max","objective":"jkbw.mem"},"bold":true}]
...
execute if entity @p[tag=jkbw_rank2] run tellraw @a ["\n",{"storage":"jk:bw","nbt":"txt.print.2nd","color":"red","bold":true}," ",{"selector":"@a[tag=jkbw_rank2]"}," - ",{"score":{"name":"#kill_max","objective":"jkbw.mem"},"bold":true}]
...
execute if entity @p[tag=jkbw_rank3] run tellraw @a ["\n",{"storage":"jk:bw","nbt":"txt.print.3rd","color":"blue","bold":true}," ",{"selector":"@a[tag=jkbw_rank3]"}," - ",{"score":{"name":"#kill_max","objective":"jkbw.mem"},"bold":true}]
...
tellraw @a ["\n",{"storage":"jk:bw","nbt":"txt.print.time_cost","color":"yellow"}," ",{"score":{"name":"#time_m","objective":"jkbw.mem"},"color":"gold"},{"text":" : ","color":"gold"},{"score":{"name":"#time_s","objective":"jkbw.mem"},"color":"gold"},"\n",{"storage":"jk:bw","nbt":"txt.print.round_end","color":"red","bold":true},"\n",{"storage":"jk:bw","nbt":"txt.print.clean_map_later","color":"green"}]