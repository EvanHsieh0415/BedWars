...
# 替换箱子为制箭台
execute if score #res_mode jkbw.mem matches 2 as @e[type=text_display,tag=jkbw_bed_display,scores={jkbw.Bed.State=0}] at @s run fill ~-4 ~ ~-4 ~4 ~3 ~4 fletching_table replace chest
