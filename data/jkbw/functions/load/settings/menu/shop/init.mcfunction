...
# 无限火力
scoreboard players set #urfEiron jkbw.mem 1
scoreboard players set #urfEgold jkbw.mem 10
scoreboard players set #urfEdiamond jkbw.mem 60
scoreboard players set #urfEemerald jkbw.mem 100

scoreboard players set #urfEleather_helmet jkbw.mem 1
scoreboard players set #urfEleather_chestplate jkbw.mem 1
scoreboard players set #urfEleather_leggings jkbw.mem 1
scoreboard players set #urfEleather_boots jkbw.mem 1
scoreboard players set #urfEgolden_helmet jkbw.mem 200
scoreboard players set #urfEgolden_chestplate jkbw.mem 500
scoreboard players set #urfEgolden_leggings jkbw.mem 300
scoreboard players set #urfEgolden_boots jkbw.mem 150
scoreboard players set #urfEdiamond_helmet jkbw.mem 500
scoreboard players set #urfEdiamond_chestplate jkbw.mem 1000
scoreboard players set #urfEdiamond_leggings jkbw.mem 800
scoreboard players set #urfEdiamond_boots jkbw.mem 500
scoreboard players set #urfEchainmail_chestplate jkbw.mem 70
...
scoreboard players set #urfEarrow jkbw.mem 100
scoreboard players set #urfEbow1 jkbw.mem 300
scoreboard players set #urfEbow2 jkbw.mem 700
scoreboard players set #urfEbow3 jkbw.mem 1100
scoreboard players set #urfEbow4 jkbw.mem 1300
scoreboard players set #urfEbow5 jkbw.mem 1500
scoreboard players set #urfEbow6 jkbw.mem 1600
...
scoreboard players set #urfEgolden_pickaxe jkbw.mem 100

scoreboard players set #urfEpotion_healing jkbw.mem 30
scoreboard players set #urfEpotion_healing2 jkbw.mem 50
scoreboard players set #urfEpotion_speed jkbw.mem 70
scoreboard players set #urfEpotion_jump jkbw.mem 88
scoreboard players set #urfEpotion_strength jkbw.mem 100
scoreboard players set #urfEpotion_regen jkbw.mem 300

scoreboard players set #urfEtnt jkbw.mem 288
