...
$summon text_display ~ ~1 ~ {Tags:["jkbw","jkbw_point","jkbw_gold_time","jkbw_iron_time","jkbw_res_spawn","jkbw_res_$(team)","jkbw_new_display"],text:'""',billboard:"center",line_width:200}
...
$summon text_display ~ ~1.4 ~ {Tags:["jkbw","jkbw_point","jkbw_iron_time","jkbw_res_spawn","jkbw_res_$(team)","jkbw_new_display"],text:'""',billboard:"center",line_width:200}
...
function jkbw:load/settings/menu/text_display
$summon text_display ~ ~1.8 ~ {Tags:["jkbw","jkbw_point","jkbw_iron_time","jkbw_res_spawn","jkbw_res_$(team)","jkbw_new_display"],text:'""',billboard:"center",line_width:200}
function jkbw:load/settings/menu/text_display
