...
$execute if score #team_point jkbw.mem matches 1 as @e[type=text_display,tag=jkbw_spawn_$(team),limit=1] at @s if block ~ ~ ~ air run data modify entity @e[type=marker,tag=jkbw_check_spawn_$(team),limit=1] CustomName set value '{"text":"■","color":"$(color)"}'
$execute if score #team_point jkbw.mem matches 1 as @e[type=text_display,tag=jkbw_spawn_$(team),limit=1] at @s unless block ~ ~ ~ air run data modify entity @e[type=marker,tag=jkbw_check_spawn_$(team),limit=1] CustomName set value '{"text":"-","color":"$(color)"}'
...
$execute if score #team_point jkbw.mem matches 1 as @e[type=text_display,tag=jkbw_chest_$(team),limit=1] at @s if block ~ ~ ~ barrel run data modify entity @e[type=marker,tag=jkbw_check_chest_$(team),limit=1] CustomName set value '{"text":"■","color":"$(color)"}'
$execute if score #team_point jkbw.mem matches 1 as @e[type=text_display,tag=jkbw_chest_$(team),limit=1] at @s unless block ~ ~ ~ barrel run data modify entity @e[type=marker,tag=jkbw_check_chest_$(team),limit=1] CustomName set value '{"text":"-","color":"$(color)"}'
